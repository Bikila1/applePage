...
// if ($(window).width() < 768) {
//   $(".footer-links-wrapper h3").click(function (e) {
//     e.preventDefault();
...
// let footerLinks = $(".footer-links-wrapper h3");
// if ($(window).width() < 768) {
// footerLinks.on("click", function (e) {
//   e.preventDefault();
//   let subLinks = $(this).next("ul"); // Get the sub-links under the respective <h3>
// subLinks.slideToggle();
//   let content = $(this).children(":after").css("content");
//   if (content === '"\f067"') {
//     $(this).children(":after").css("content", '"\f00d"');
//   } else {
//     $(this).children(":after").css("content", '"\f067"');
//   }
// });
// };
